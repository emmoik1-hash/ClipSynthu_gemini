...
import { FileUploadIcon, LinkIcon, SpinnerIcon, XCircleIcon } from '@/components/icons/Icons';
  ...
  const renderContent = () => {
    switch (status) {
      ...
      case UploadStatus.SUCCESS:
        return <EditorView videoDetails={videoDetails!} onReset={handleReset} />;
...
const ProgressView: React.FC<{ status: UploadStatus; progress: number }> = ({ status, progress }) => {
  ...
  return (
    <div className="text-center bg-gray-800 rounded-2xl shadow-lg p-8">
